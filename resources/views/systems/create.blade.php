        ...
        <div>
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Crear Aplicación o Sistema</h3>
                </div>
                @if($errors->any())
                ...
                <form class="form-horizontal" method="POST" action="{{ route('systems.store') }}">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <input system="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Nombre">
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
                    <div class="box-footer">
                        <button system="submit" class="btn btn-success pull-left">Crear</button> | 
