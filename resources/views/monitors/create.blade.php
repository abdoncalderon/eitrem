    ...
    <section class="content">
        <div>
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('monitors.store') }}">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="checkbox" class="form-check-input" id="hdmi" class="form-control" name="hdmi" onchange="checkHDMI();">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="checkbox" class="form-check-input" id="vga" class="form-control" name="vga" onchange="checkVGA();">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" class="form-check-input" id="dp" class="form-control" name="dp" onchange="checkDP();">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <select name="storedin" class="form-control" data-placeholder="Ubicación" style="width: 100%;">0
