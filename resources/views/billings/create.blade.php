    ...
    <section class="content">
        <div>
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('billings.store') }}">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <input type="text" class="form-control" name="date" placeholder="AAAA/MM/DD" value="{{ old('date') }}">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">Factura Nº</label>
                            <div class="col-sm-10" >
                                <input type="text" class="form-control" name="number" value="{{ old('number') }}" placeholder="Número de Factura" maxlength="15">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <select name="provider" class="form-control" data-placeholder="Proveedor" style="width: 100%;">
