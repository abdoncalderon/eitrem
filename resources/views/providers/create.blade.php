                ...
                <form class="form-horizontal" method="POST" action="{{ route('providers.store') }}">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <input type="text" class="form-control" name="contact" value="{{ old('contact') }}" placeholder="Contacto">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <input type="text" class="form-control" name="phone1" value="{{ old('phone1') }}" placeholder="Telefono Convencional">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <input type="text" class="form-control" name="phone2" value="{{ old('phone2') }}" placeholder="Telefono Celular">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <input type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="Email de contacto">
                            </div>
                        </div>
